        ...
        static void Main(string[] args)
        {
            ...
            if ((args.Length!=0) && (args!=null))
            {
                ...
                if (args[0] == "install")
                {
                    ...
                    {
                        DialogResult installrslt = MessageBox.Show("Хотите установить в реестр?", "Приложение не установлено", MessageBoxButtons.OKCancel);
                    ...
                    if (args[1] == "user")
                    {
                        DialogResult installuserrslt = MessageBox.Show("В реестре нет настроек пользователя. Создать?", "Приложение не установлено", MessageBoxButtons.OKCancel);
